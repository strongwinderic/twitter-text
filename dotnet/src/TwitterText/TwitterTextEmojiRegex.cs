...
{
    public class TwitterTextEmojiRegex
    {
        ...
        public static readonly SystemRegex VALID_EMOJI_PATTERN;

        static TwitterTextEmojiRegex()
        {
            VALID_EMOJI_PATTERN = new SystemRegex(EMOJI);
